/**
 * CHASS JRA Drive Prediction Input v1.4.1
 *
 * Hybrid input:
...
export const JRA_DRIVE_INPUT_SCHEMA_VERSION = 'jra-drive-input-v1.4.1';
...
export async function addJraDrivePredictionInput(env = {}, official = {}) {
  ...
  const context = {
    ...
    track: official?.track || official?.race?.racecourse,
    race: Number(official?.race || official?.race?.raceNo),
  };
