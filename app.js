...
function makeSnapshot(){
 const now=new Date().toISOString(),identity=activeRaceIdentity(),ranked=raceTypeOf(state)==='JRA'?[...state.horses].sort((a,b)=>(b.overall??0)-(a.overall??0)||(b.win??0)-(a.win??0)):rankFinal(),modelVersion=state.race?.jraModelVersion||APP_VERSION;
