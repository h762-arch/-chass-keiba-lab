...
function createMcpServer(){
 const server=new McpServer({name:'chass-keiba-lab',version:CONNECTOR_VERSION},{instructions:'Read-only CHASS KEIBA LAB research connector. Original Snapshot is the official research prediction. Current scratch handling is status-only; legacy Live Adjusted data may be read only for historical compatibility. Never imply that these tools update predictions, D1, JRA, or NAR.'});
